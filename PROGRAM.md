...
Improve the performance of ES abstract operations by 5% or more, measured by aggregate operations-per-second across commonly used operations (Type, ToString, ToNumber, IsCallable). Baseline: ~42M ops/sec.

## What you CAN modify

- `2024/**/*.js` — ES2024 abstract operation implementations
- `2023/**/*.js` — ES2023 abstract operation implementations
- `2022/**/*.js` — ES2022 abstract operation implementations
- `2021/**/*.js` — ES2021 abstract operation implementations
- `2020/**/*.js` — ES2020 abstract operation implementations
- `2019/**/*.js` — ES2019 abstract operation implementations
- `2018/**/*.js` — ES2018 abstract operation implementations
- `2017/**/*.js` — ES2017 abstract operation implementations
- `2016/**/*.js` — ES2016 abstract operation implementations
- `2015/**/*.js` — ES2015 abstract operation implementations
- `5/**/*.js` — ES5 abstract operation implementations
- `helpers/**/*.js` — helper functions used by abstract operations
...
- `test/**/*.js` — test suite (must pass without modification)
- `package.json` — dependencies and scripts
- `operations/**/*.js` — build and spackle scripts
- `es*.js` — entry point files (es5.js, es2015.js, etc.)
